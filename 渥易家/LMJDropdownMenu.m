...
- (void)createMainBtnWithFrame:(CGRect)frame{
    ...
    [_mainBtn setTitleColor:getColor(@"7fa91e") forState:UIControlStateNormal];
    ...
    _mainBtn.backgroundColor    = getColor(@"1a1a1a");
...
//    _mainBtn.layer.borderWidth  = 1;
    ...
    // 旋转尖头
    _arrowMark = [[UIImageView alloc] initWithFrame:CGRectMake(_mainBtn.frame.size.width - 20, 0, 15, 9)];
    _arrowMark.center = CGPointMake(VIEW_CENTER_X(_arrowMark), VIEW_HEIGHT(_mainBtn)/2);
    _arrowMark.image  = [UIImage imageNamed:@"向下"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        cell.textLabel.textColor     = getColor(@"7fa91e");
        cell.selectionStyle          = UITableViewCellSelectionStyleNone;
        cell.backgroundColor = getColor(@"1a1a1a");
