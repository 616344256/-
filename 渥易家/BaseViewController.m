...
//    }
    ...
    [self.navigationController.navigationBar setBarTintColor:getColor(@"1a1a1a")];
    [self.navigationController.navigationBar setTintColor:getColor(@"80aa1f")];

    UIColor * color = getColor(orangeColor);
    NSDictionary * dict=[NSDictionary dictionaryWithObject:color forKey:NSForegroundColorAttributeName];
    self.navigationController.navigationBar.titleTextAttributes = dict;
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.0f],NSForegroundColorAttributeName: getColor(@"80aa1f")}];
